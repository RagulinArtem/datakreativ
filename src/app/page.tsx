        ...
        <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-grid">
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
            ...
            <p className="animate-fade-in-up opacity-0 animate-delay-200 mx-auto mt-6 max-w-2xl text-lg text-zinc-400 md:text-xl">
              Настройте параметры размещения, загрузите баннер или OLV-креатив
              и получите прогноз CTR или VTR, оценку эффективности и
              рекомендации по улучшению за секунды.
            </p>
              ...
              {[
                {
                  ...
                  title: "Прогноз CTR",
                  desc: "Прогноз CTR или VTR в формате диапазона и сравнение со средним бенчмарком",
                },
                {
                  icon: (
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  title: "Контекст размещения",
                  desc: "Ниша, возраст, тип креатива, формат, устройство и KPI реально влияют на прогноз",
                },
                {
                  icon: (
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  ...
                  title: "Рекомендации",
                  desc: "Конкретные советы для усиления сообщения, контраста, первых секунд и CTA",
                },
              ].map((feature, i) => (
                <div
                  key={i}
              ...
              {[
                {
                  ...
                  desc: "Ниша, возраст, тип креатива, формат размещения, устройство и KPI кампании",
                },
                {
                  step: "02",
                  title: "Загрузите креатив",
                  desc: "Загрузите изображение баннера или OLV-видео для анализа в нужном контексте размещения",
                },
                {
                  step: "03",
                  title: "Получите прогноз",
                  desc: "Диапазон CTR или VTR, разбор элементов, сильные и слабые стороны и рекомендации",
                },
              ].map((item, i) => (
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
              ...
              <p className="text-sm text-zinc-500">
                AI-платформа для анализа баннеров и OLV-креативов
              </p>
            </div>
          </div>
        </footer>
